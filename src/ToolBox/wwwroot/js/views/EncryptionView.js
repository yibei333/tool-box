const EncryptionView = {
    ...
    <div>
        <div class="glass rounded-2xl p-6 shadow-xl">
            ...
            <!-- RSA Section -->
            <div v-if="mainTab === 'rsa'" :style="{ height: contentHeight + 'px' }">
                ...
                <div v-if="rsaTab === 'generate'">
                    ...
                    <div class="flex gap-2 min-h-130">
                ...
                <!-- RSA Compare -->
                <div v-if="rsaTab === 'compare'" class="flex flex-col gap-2 min-h-130">
                ...
                <div v-if="rsaTab === 'convert'">
                    <div class="flex flex-col gap-2 min-h-130">
                ...
                <div v-if="rsaTab === 'xml-convert'">
                    ...
                    <!-- PEM to XML -->
                    <div v-if="xmlConvertDirection === 'pem-to-xml'">
                        <div class="flex flex-col gap-2 min-h-130">
                            ...
                            <div class="flex-1 flex flex-col">
                                ...
                                <textarea v-model="rsaXmlResult" readonly placeholder="XML结果..."
                                    class="w-full flex-1 rounded-xl border border-gray-300 px-4 py-2.5 mono text-sm bg-gray-50 outline-none resize-none break-all"></textarea>
                            </div>
                        </div>
                    </div>

                    <!-- XML to PEM -->
                    <div v-if="xmlConvertDirection === 'xml-to-pem'">
                        <div class="flex flex-col gap-2 min-h-130">
                            <div class="flex-1 flex flex-col gap-2">
                                <div class="flex-1 flex flex-col">
                                    <label class="block text-sm font-medium text-gray-700 mb-1">XML密钥</label>
                                    <textarea v-model="rsaXmlXml" placeholder="粘贴XML密钥..."
                                        class="w-full flex-1 rounded-xl border border-gray-300 px-4 py-2.5 mono text-xs focus:border-indigo-500 outline-none resize-none break-all"></textarea>
                                </div>
                                <div>
                            ...
                            <div class="flex-1 flex flex-col">
                                ...
                                <textarea v-model="rsaXmlFromXmlResult" readonly placeholder="PEM结果..."
                                    class="w-full flex-1 rounded-xl border border-gray-300 px-4 py-2.5 mono text-sm bg-gray-50 outline-none resize-none"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div v-if="rsaTab === 'password'">
                    ...
                    <!-- Add Password -->
                    <div v-if="passwordOperation === 'add'">
                        <div class="grid grid-cols-2 gap-6 min-h-130">
                            <div class="flex flex-col gap-2">
                                ...
                                <div v-if="rsaPasswordTargetEncryptedType==='EncryptedPkcs1PrivateKey'">
                    ...
                    <!-- Remove Password -->
                    <div v-if="passwordOperation === 'remove'">
                        <div class="grid grid-cols-2 gap-6 min-h-130">
                            <div class="flex flex-col gap-2">
                                <div class="flex-1 flex flex-col">
                    ...
                    <div class="grid grid-cols-2 gap-6 min-h-130">
                        <div class="flex flex-col gap-2">
                            ...
                            <div>
                                ...
                                <select v-model="rsaEncPadding" class="w-full rounded-xl border border-gray-300 px-3 py-2 text-sm focus:border-indigo-500 outline-none">
                ...
                <div v-if="rsaTab === 'decrypt'">
                    <div class="grid grid-cols-2 gap-6 min-h-130">
                        <div class="flex flex-col gap-2">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">填充模式</label>
                                <select v-model="rsaDecPadding" class="w-full rounded-xl border border-gray-300 px-3 py-2 text-sm focus:border-indigo-500 outline-none">
                                    <option value="OAEP-SHA256">OAEP-SHA256</option>
                                    <option value="OAEP-SHA384">OAEP-SHA384</option>
                                    <option value="OAEP-SHA512">OAEP-SHA512</option>
                                    <option value="OAEP-SHA1">OAEP-SHA1</option>
                ...
                <div v-if="rsaTab === 'sign'">
                    <div class="grid grid-cols-2 gap-2 min-h-130">
                        <div class="flex flex-col gap-2">
                            <div class="flex-1 flex flex-col">
                                <label class="block text-sm font-medium text-gray-700 mb-1">私钥</label>
                ...
                <div v-if="rsaTab === 'verify'">
                    <div class="flex flex-col gap-2 min-h-130">
                        <div class="flex-1 flex flex-col gap-2">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">哈希算法</label>
                                <select v-model="rsaVerifySignHashAlgorithm" class="w-full rounded-xl border border-gray-300 px-3 py-2 text-sm focus:border-indigo-500 outline-none">
                                    <option value="SHA256">SHA256</option>
                                    <option value="SHA384">SHA384</option>
                                    <option value="SHA512">SHA512</option>
                                    <option value="SHA1">SHA1</option>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">填充模式</label>
                                <select v-model="rsaVerifySignPadding" class="w-full rounded-xl border border-gray-300 px-3 py-2 text-sm focus:border-indigo-500 outline-none">
                                    <option value="PKCS1">PKCS1</option>
                                    <option value="PSS">PSS</option>
                                </select>
                            </div>
