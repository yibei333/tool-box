            ...
            <div class="grid grid-cols-2 gap-6">
                <div class="space-y-4">
                    ...
                    <input type="datetime-local" v-model="datetime"
                        class="w-full rounded-xl border border-gray-300 px-4 py-2.5 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition">
                ...
                <div class="space-y-4">
                    ...
                    <input type="text" v-model="timestamp" placeholder="输入时间戳（秒或毫秒）"
                        class="w-full rounded-xl border border-gray-300 px-4 py-2.5 mono focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none transition">
